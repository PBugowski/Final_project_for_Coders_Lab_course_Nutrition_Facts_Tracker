...
def test_get_profile_view_for_logged_in_user(client, create_login):
    ...
    # assert response.context['date_joined'] == '2024-07-01 14:14:39.301207 +00:00'
    # assert response.context['last_login'] == '2024-07-08 10:59:45.859541 +00:00'
...
# @pytest.mark.django_db
# def test_add_nutrition_facts_view_for_logged_in_user(client):
